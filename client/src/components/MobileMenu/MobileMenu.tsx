    ...
    <Container>
      ...
      >
        ...
        <path
          ...
          stroke="white"
        />
        <Link to="/library" onClick={() => setActiveTab(1)}>
          <circle cx="141" cy="108" r="25" fill="white" />
        </Link>

        <circle cx="269" cy="104" r="30" fill="#2B41A7" />
        <Link to="/training" onClick={() => setActiveTab(2)}>
          <circle cx="273" cy="108" r="25" fill="white" />
        </Link>

        <Link to="/settings" onClick={() => setActiveTab(3)}>
          <circle cx="375" cy="108" r="25" fill="white" />
        </Link>
        ...
        <path
          ...
          fill={activeTab === 0 ? '#F24E1E' : '#2B41A7'}
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill={activeTab === 1 ? '#F24E1E' : '#2B41A7'}
        />
        <path
        ...
        <path
          ...
          stroke={activeTab === 2 ? '#F24E1E' : '#2B41A7'}
          strokeWidth="2.08333"
          strokeLinecap="round"
        ...
        <path
          ...
          stroke={activeTab === 3 ? '#F24E1E' : '#2B41A7'}
          strokeWidth="2.1875"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
